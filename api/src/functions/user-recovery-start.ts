...
const RecoveryEmailText = `Recover Your SWRDL Account
-------------------------------------------------------
You're receiving this email because you requested access to your SWRDL account.
To get back into SWRDL, you'll need to click the button below on your mobile device.

** This will only work on the same device where SWRDL is installed. **

Click this link to recover your account:

%RECOVERY_LINK%

If you didn't request this, fear not. Your SWRDL account can't be accessed without
the link above.
...
const RecoveryEmailHtml = `<!doctype html><html xmlns="http://www.w3.org/1999/xhtml" xmlns:v="urn:schemas-microsoft-com:vml" xmlns:o="urn:schemas-microsoft-com:office:office"><head><title></title><!--[if !mso]><!--><meta http-equiv="X-UA-Compatible" content="IE=edge"><!--<![endif]--><meta http-equiv="Content-Type" content="text/html; charset=UTF-8"><meta name="viewport" content="width=device-width,initial-scale=1"><style type="text/css">#outlook a { padding:0; }
...
</td></tr></table><![endif]--></td></tr><tr><td align="left" style="font-size:0px;padding:10px 25px;word-break:break-word;"><div style="font-family:helvetica;font-size:18px;line-height:1;text-align:left;color:#000000;">Recover Your Account</div></td></tr><tr><td align="left" style="font-size:0px;padding:10px 25px;word-break:break-word;"><div style="font-family:helvetica;font-size:16px;line-height:1.5;text-align:left;color:#000000;">You're receiving this email because you requested access to your SWRDL account. To get back into SWRDL, you'll need to click the button below on your mobile device.</div></td></tr><tr><td align="left" style="font-size:0px;padding:10px 25px;word-break:break-word;"><div style="font-family:helvetica;font-size:16px;font-weight:bold;line-height:1.5;text-align:left;color:#000000;">This will only work on the same device where SWRDL is installed.</div></td></tr><tr><td align="center" vertical-align="middle" style="font-size:0px;padding:10px 25px;padding-top:40px;padding-bottom:40px;word-break:break-word;"><table border="0" cellpadding="0" cellspacing="0" role="presentation" style="border-collapse:separate;width:280px;line-height:100%;"><tr><td align="center" bgcolor="#AA02AD" role="presentation" style="border:none;border-radius:3px;cursor:auto;mso-padding-alt:10px 25px;background:#AA02AD;" valign="middle"><a href="%RECOVERY_LINK%" style="display:inline-block;width:230px;background:#AA02AD;color:#ffffff;font-family:Ubuntu, Helvetica, Arial, sans-serif;font-size:17px;font-weight:bold;line-height:120%;margin:0;text-decoration:none;text-transform:none;padding:10px 25px;mso-padding-alt:0px;border-radius:3px;" target="_blank">Recover My Account</a></td></tr></table></td></tr><tr><td align="left" style="font-size:0px;padding:10px 25px;word-break:break-word;"><div style="font-family:helvetica;font-size:16px;line-height:1.5;text-align:left;color:#000000;">If you didn't request this, fear not. Your SWRDL account can't be accessed without the link above.</div></td></tr><tr><td align="left" style="font-size:0px;padding:10px 25px;word-break:break-word;"><div style="font-family:helvetica;font-size:16px;line-height:1.5;text-align:left;color:#000000;">As part of our commitment to privacy, SWRDL does not store your email address and cannot contact you unless specifically requested.</div></td></tr><tr><td align="left" style="font-size:0px;padding:10px 25px;word-break:break-word;"><div style="font-family:helvetica;font-size:14px;line-height:1.5;text-align:left;color:#000000;">Questions or concerns? Reach out to us at <a style="color: #AA02AD" href="mailto:hello@swrdl.com">hello@swrdl.com</a> or reply to this email.</div></td></tr><tr><td align="center" style="font-size:0px;padding:10px 25px;word-break:break-word;"><div style="font-family:Ubuntu, Helvetica, Arial, sans-serif;font-size:11px;line-height:16px;text-align:center;color:#445566;">&copy; SWRDL.app, All Rights Reserved.</div></td></tr></tbody></table></div><!--[if mso | IE]></td></tr></table><![endif]--></td></tr></tbody></table></div><!--[if mso | IE]></td></tr></table><![endif]--></div></body></html>`;
...
export const handler = async (event: APIGatewayProxyEventV2): Promise<APIGatewayProxyResultV2> => {
    ...
    const user = await db.userGetByEmailHash(emailHash);
    ...
    const sig = crypto
        ...
        .update(`recover|${id}|${iss}|${exp}`, 'utf-8')
        .digest('base64');
    const recoveryToken = URLSafeBase64.encode(Buffer.from(JSON.stringify({ id, iss, exp, sig }), 'utf-8'));
    const recoveryLink = `https://${process.env.WWW_DOMAIN}/r/${recoveryToken}`;

    console.log('Sending recovery email to', emailAddress, 'with token', recoveryToken);
    const msg: MailDataRequired = {
        to: emailAddress,
        from: { name: 'SWRDL', email: 'hello@swrdl.app' },
        subject: 'Recover your SWRDL account',
        text: RecoveryEmailText.replace('%RECOVERY_LINK%', recoveryLink),
        html: RecoveryEmailHtml.replace('%RECOVERY_LINK%', recoveryLink),
    };
