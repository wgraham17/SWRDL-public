...
function PrivacyPage() {
    return (
        <>
            <Helmet>
                <title>Privacy | SWRDL</title>
            </Helmet>
            <main className="overscroll">
                ...
                <ul>
                    ...
                    <li>
                        <p>
                            ...
                            by You on any electronic device, named SWRDL
                        </p>
                    </li>
                    <li>
                        <p>
                            <strong>Company</strong> (referred to as either &quot;the Company&quot;, &quot;We&quot;,
                            &quot;Us&quot; or &quot;Our&quot; in this Agreement) refers to SWRDL.
                        </p>
                    </li>
                    <li>
                        <p>
                ...
                <ul>
                    <li>By email: hello@swrdl.app</li>
                </ul>
            </main>
        </>
    );
